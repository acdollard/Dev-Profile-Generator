...
const generateHTML_ASYNC = util.promisify(generateHTML)
...
const colors = {
  ...
  <html lang="en">
    ...
    // .then(function({username, color_choice}){
...
questions.then((data) => 
    ...
    axios.then((response) => 
        {
        const htmlPage = generateHTML_ASYNC({response, data});
